...
# 3) Insert below record by increasing 10% of estimated_sale_price to the given estimated_sale_price 
  ...
  insert into bank_inventory values  ('DailyCard', 2, 380.00, 8500.87, 9000.00,default);
  update bank_inventory  set estimated_sale_price = estimated_sale_price + (estimated_sale_price*0.15) where product = 'dailycard';
...
delete from bank_inventory where estimated_sale_price - Purchase_cost < estimated_sale_price*0.15;
